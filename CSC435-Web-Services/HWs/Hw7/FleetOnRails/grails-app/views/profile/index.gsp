...
<html lang="en">
    ...
    <div class="modal fade" id="imagePicker" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="myModalLabel">Customization</h4>
                    <div class="form-horizontal form-group form-control">
                        <input id="custSearch" placeholder="Search">
                        <button id="custSearchButton" type="button" class="btn btn-primary">Search</button>
                    </div>
                </div>
                <div class="modal-body">
                    <div id="imageContainer" class="container-fluid" style="max-height: 500px; overflow: auto;">

                    </div>
                </div>
                <div class="modal-footer">
                    <button id="setProfile" type="button" class="btn btn-info">Profile</button>
                    <button id="setBack" type="button" class="btn btn-primary">Background</button>
            ...
            <div class="row profile" style="width: 100%">
                <div class="col-md-3">
                    <div class="profile-sidebar" style="margin: auto">
                        <div id="myProf" class="profile-userpic" style="margin: auto">
                        ...
                        <div class="profile-userbuttons" style="margin: auto">
                            <button id="customize" type="button" class="btn btn-danger btn-sm">Customize</button>
                        </div>
                                       ...
                                       <div id="messages" style="max-height: 600px;overflow: auto">
                                        ...
                                        %{--<g:form controller="setter" action="index">--}%
                                            <div class="form-group-lg">
                                                ...
                                                <input id="from" style="display: none" value="${user.getUsername()}">
