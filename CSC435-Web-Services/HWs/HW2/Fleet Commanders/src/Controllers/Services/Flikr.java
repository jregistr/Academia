...
public class Flikr extends Controller{
    ...
    private JsonElement[] getIds(JsonObject flikrObj){
    ...
    private String getImage(JsonElement id) {
    ...
    private BufferedReader getConnectionStreamReader(HttpURLConnection connection){
        if(connection != null){
