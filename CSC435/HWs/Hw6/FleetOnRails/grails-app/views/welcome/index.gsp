...
<html>
    ...
    <body class="container-fluid" style="background-image: url(http://i626.photobucket.com/albums/tt345/thedragonblade/introBack.png);background-size: 100%">
        ...
        <div class="row" style="display: table; max-width: 1400px; margin: 0 auto">
            <div class="col-lg-8" style="display: table-cell">
                <div class="panel" style="margin-top: 400px">
            ...
            <div class="col-lg-4" style="display: table-cell;min-height: 620px; background-color: #f5f5f5">
                ...
                <g:form controller="register" action="index" class="form-group-lg" style="margin: 30px auto;">
