...
<head>
    ...
    <%int viewID = (Integer)request.getAttribute(Controller.VIEWING_ID_PARAMETER);%>
    <%String viewBack = Customization.retrieveBackgroundPic(viewID);%>
    <%String viewProf = Customization.retrieveProfilePic(viewID);%>


    <body class="container-fluid" id="profileBody" style="min-width: 1000px; background-image: url(${pageContext.request.contextPath}/images/backs/<%=viewBack%>)">
        <header>
            <ul class="nav-left">
        ...
        <div id="mainDisplay">
            <div class="row" style="width: 100%; height: 80px; margin: auto; padding: 5px; background-color: #f5f5f5">
                <div style="width: 80px; height: 90%;float: left; margin: auto">
                    <img class="imgFit" src="${pageContext.request.contextPath}/images/pics/<%=viewProf%>">
                </div>
                <h2 class="text-capitalize"><b><%=User.retrieveName(viewID)%></b></h2>
            </div>
            <div class="row mainDisplayRow" role="tabpanel">
                ...
                <div id="my-tab-content" class="tab-content">
                    <%Battle[] battles = Battle.retrieve(viewID);%>
                    <%--<%int id = (Integer)request.getAttribute(Controller.USER_ID_PARAMETER);%>--%>
                    <div role="tabpanel" class="tab-pane row myTabBody active" id="Overview">
                        <div class="col-xs-4 myTabBodyCol">
                            <h2 style="margin:auto;text-align: center;"><%=User.retrieveName(viewID)%></h2>
                            <div style="width: 95%;height: 600px; margin: auto;">
                                <img class="imgFitScale" style="margin: auto;" src="${pageContext.request.contextPath}/images/pics/<%=viewProf%>">
                            </div>
                        </div>
                        <div class="col-xs-4 myTabBodyCol">
                    ...
                    <div role="tabpanel" class="tab-pane myTabBody" id="Chat">
                        <div class="col-xs-4">
                            <%Comment[] comments = Comment.retrieve(viewID);%>
                            ...
                            <div>
                                <form class="form-group-lg" method="post" action="Profile">
                                    ...
                                    <button name="<%=Controller.VIEWING_ID_PARAMETER%>" value="<%=viewID%>" class="form-control btn btn-primary" type="submit">Post</button>
                                </form>
                            </div>
                        </div>
                    </div>
