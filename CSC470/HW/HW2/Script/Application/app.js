...
$( document ).ready(function() {
    ...
    var Application = (function(){
        ...
        /*webgl utilities*/
        var canvas, gl, program, verticies, colors
        ...
        function initVertsAndColors(){
            ...
            $.each(squares, function(index, value){
                ...
                colors = Util.pushList(color, color, color, color, color, color, colors)
                verticies = Util.pushList(Vecs.flatten(value.flatten()), verticies)
//                var center = Vecs.flatten(value.position())
//                console.log(center)
            })
        }
        ...
        function setShaderInputLocations(){
            if(continueExecution){
                ...
                program.theta = gl.getUniformLocation(program, "theta")
//                program.aCenterPos = gl.getAttribLocation(program, "aCenterPos")
            }
        }
