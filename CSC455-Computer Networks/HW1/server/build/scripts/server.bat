...
set CLASSPATH=%APP_HOME%\lib\server-1.0-SNAPSHOT.jar;%APP_HOME%\lib\scala-library-2.12.0-M3.jar

@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" metermen.ServerMain %CMD_LINE_ARGS%
